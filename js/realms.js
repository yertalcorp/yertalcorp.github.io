...
console.log(`%c YERTAL REALMS-FX LOADED | ${new Date().toLocaleDateString()} @ 12:50:00 `, "background: #000; color: #00f2ff; font-weight: bold; border: 1px solid #00f2ff; padding: 4px;");
...
function renderHowRealmsWork(data) {
    ...
    el.innerHTML = `
        <div class="max-w-7xl mx-auto px-6">
            ...
            <p class="text-slate-400 text-xs font-mono tracking-wider uppercase max-w-2xl mx-auto mb-10 opacity-80">${data.subtitle || 'From single prompt to an interactive 3D virtual environment.'}</p>
            
            <div class="flex flex-row items-center justify-center gap-4 max-w-3xl mx-auto mb-16 font-mono text-xs">
