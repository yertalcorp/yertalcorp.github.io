...
console.log(`%c YERTAL SPARKS LOADED | ${new Date().toLocaleDateString()} @ 19:52:00 `, "background: var(--branding-color); color: var(--bg-color); font-weight: bold; border: 1px solid var(--branding-color); padding: 4px;");
