...
console.log(`%c YERTAL ARCADE LOADED | ${new Date().toLocaleDateString()} @ 20:55:00 `, "background: var(--branding-color-darkest); color: var(--branding-color); font-weight: bold; border: 1px solid #00f2ff; padding: 4px;");
