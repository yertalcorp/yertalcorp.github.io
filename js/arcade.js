...
console.log(`%c YERTAL ARCADE LOADED | ${new Date().toLocaleDateString()} @ 21:07:00 `, "background: var(--bg-color); color: var(--branding-color); font-weight: bold; border: 1px solid var(--branding-color); padding: 4px;");
