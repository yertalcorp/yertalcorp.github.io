...
console.log(`%c YERTAL ARCADE LOADED | ${new Date().toLocaleDateString()} @ 12:41:00 `, "background: #000; color: #007470; font-weight: bold; border: 1px solid #00f2ff; padding: 4px;");
        ...
        const controls = (isOwner && !isFull) ? `
            <div style="display: flex; align-items: center; gap: 0; margin-left: auto; background: rgba(0,0,0,0.6); border: 1px solid rgba(0,242,255,0.2); border-radius: 4px; padding: 2px 10px; box-shadow: inset 0 0 10px rgba(0,0,0,0.5);">
                ...
                <input type="text" id="input-${current.id}" 
                       ...
                       class="glass"
                       style="background: transparent; border: none; padding: 0.5rem 0; font-size: 10px; flex: 1; max-width: 800px; outline: none; color: white; font-family: 'Orbitron', sans-serif; letter-spacing: 2px;"
