...
console.log(`%c YERTAL ARCADE LOADED | ${new Date().toLocaleDateString()} @ 13:35:00 `, "background: #000; color: #007470; font-weight: bold; border: 1px solid #00f2ff; padding: 4px;");
