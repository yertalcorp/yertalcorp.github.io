...
console.log(`%c YERTAL ARCADE LOADED | ${new Date().toLocaleDateString()} @ 22:39:00 `, "background: var(--bg-color); color: var(--branding-color); font-weight: bold; border: 1px solid #00f2ff; padding: 4px;");
