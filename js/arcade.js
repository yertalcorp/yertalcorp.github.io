...
function shapeAiPrompt(rawPrompt, count, mode, currentName, promptTypeObject) {
    ...
    if (isSource) {
        ...
        instructions = `Write a visually stunning, fully working HTML/Javascript application with gradient colors and 3D objects.
                     - Format: JSON object {"name", "code", "thumbnail"} and name has maximum 3 words. The thumbnail must be an existing, publicly available and high-resolution image URL relevant to the name and ${promptTypeObject.name}.`;
    } 
